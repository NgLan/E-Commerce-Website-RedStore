...
//            response.sendRedirect("cart"); // Chuyển hướng hoặc xử lý lỗi nếu index không hợp lệ
//            return;
//        }
...
//        if (index < 0 || index >= listP.size()) {
//            response.sendRedirect("cart"); // Xử lý khi index ngoài giới hạn
//            return;
//        }
